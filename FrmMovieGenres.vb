Public Class FrmMovieGenres
    ...
    Private Sub FrmMovieGenres_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        Dim returnArray() As String = DbReadRecord("SELECT * FROM genre", selectArray)
    ...
    Private Sub BtnDelete_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BtnDelete.Click
        If lstGenres.SelectedItems.Count <= 0 Then Return
    ...
    Private Sub DeleteMovieGenre() 
        ...
        Dim returnArray() As String = DbReadRecord(sqlStatement, selectArray)
        Dim genreId = returnArray(0)

        'Remove it from the Genre_link table for tv shows and movies
